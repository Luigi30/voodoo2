...
[$(OBJ_DIR)]FXDRIVER.obj -                                                    !auto
[$(OBJ_DIR).example]driver.obj                                                !auto
    CXXLINK $(LINKFLAGS) $(MMS$SOURCE_LIST)                                   !auto
                                                                              !auto
! objects                                                                     !auto
[$(OBJ_DIR)]FXDRIVER.obj : FXDRIVER.C $(INCLUDES)                             !auto
[$(OBJ_DIR).example]driver.obj : [.example]driver.c $(INCLUDES)               !auto
